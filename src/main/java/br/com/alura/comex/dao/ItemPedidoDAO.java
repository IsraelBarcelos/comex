...
import br.com.alura.comex.vo.RelatorioDeClientesMaisLucrativosVO;
import br.com.alura.comex.vo.RelatorioDeProdutosMaisVendidosVO;
...
public class ItemPedidoDAO {
    ...
    public List<RelatorioDeProdutosMaisVendidosVO> produtosMaisVendido() {
        ...
        return this.em
                .createQuery(
                        "SELECT new br.com.alura.comex.vo.RelatorioDeProdutosMaisVendidosVO( "
                                + "i.produto.nome, "
                                + "count(i.produto.id)) "
                                + "from ItemPedido i "
    ...
    public List<RelatorioDeClientesMaisLucrativosVO> listaClientesMaisLucrativos() {
        return this.em
                .createQuery(
                        "SELECT new br.com.alura.comex.vo.RelatorioDeClientesMaisLucrativosVO(i.pedido.cliente, sum(i.precoUnitario * i.quantidade) as lucro) "
                                + "from ItemPedido i "
